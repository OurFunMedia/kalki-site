        ...
        <div className="min-h-screen pt-24 px-6 md:px-12 bg-cream text-charcoal">
            ...
            <div className="max-w-6xl mx-auto pb-20">
                <div className="grid md:grid-cols-3 gap-8 md:gap-12 max-w-6xl mx-auto px-4 md:px-0">
                    {/* Card 1 */}
                    <div className="border-2 border-primary bg-white aspect-[3/4] md:aspect-[4/5] flex flex-col items-center justify-center p-8 md:p-12 text-center shadow-sm hover:shadow-md transition-shadow">
